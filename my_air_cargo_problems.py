...
#        Set the current conditions that are true and are false and are decoded from the state
        ...
        for action in self.actions_list:
            is_possible = True
#            Evaluate the positive conditional requirements against the received conditions
            for clause in action.precond_pos:
#                 if one condition is already failed, don't waste time evaluating the rest...
                if (is_possible ==False):
                    continue
                if clause not in kb.clauses:
                    is_possible = False
#            Evaluate the negative conditional requirements against the received conditions
